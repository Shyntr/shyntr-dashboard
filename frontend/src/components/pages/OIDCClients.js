                  ...
                  >
                    <TableCell>
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2">
                          ...
                          <CopyButton value={client.client_id} testId={`copy-client-id-${client.client_id}`} />
                        </div>
                        {client.name && (
                    ...
                    <TableCell className="hidden md:table-cell">
                      <div className="flex items-center gap-2">
                        ...
                        <CopyButton value={client.client_secret} testId={`copy-secret-${client.client_id}`} />
                      </div>
                    </TableCell>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {RESPONSE_TYPES.map((type) => (
                      <Badge
                        ...
                        data-testid={`response-type-${type}`}
                      >
                        {type}
                      </Badge>
                    ))}
