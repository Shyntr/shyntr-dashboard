                        ...
                        <div className="flex items-center justify-between p-4 hover:bg-muted/50 transition-colors">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span
                                        className="text-xs text-muted-foreground">Change the dashboard look and feel</span>
                                </div>
                            </div>
                                ...
                                >
                                    <div className="flex items-start sm:items-center gap-4">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span
                                                className="text-xs text-muted-foreground">{endpoint.description}</span>
                                        </div>
                                    </div>

                                    <div
                                        className="flex items-center gap-2 w-full sm:w-auto mt-2 sm:mt-0 bg-muted/50 p-1.5 rounded-lg border">
                                        <code
                                            className="text-xs text-muted-foreground truncate max-w-[200px] sm:max-w-[250px] px-2">
                                            {endpoint.url}
                                        </code>
                                        <div className="flex items-center gap-1 border-l pl-2">
                                            <Button
                                                ...
                                                title={`Copy ${endpoint.title}`}
                                                aria-label={`Copy ${endpoint.title}`}
                                            >
                                            ...
                                            <Button
                                                ...
                                                title={`Open ${endpoint.title}`}
                                                aria-label={`Open ${endpoint.title}`}
                                            >
